...
class UserInfo(models.Model):
    ...
    user = fields.ForeignKeyField('diff_models.Users', related_name='user_info')
    created_at = fields.DatetimeField(auto_now_add=True)
    modified_at = fields.DatetimeField(auto_now=True)
...
class UserThirdAuth(models.Model):
    ...
    user = fields.ForeignKeyField('diff_models.Users', related_name='user_third_auth')
    created_at = fields.DatetimeField(auto_now_add=True)
    modified_at = fields.DatetimeField(auto_now=True)
...
class WechatAppUsers(models.Model):
    ...
    user = fields.ForeignKeyField('diff_models.Users', related_name='wechat_app_user')
    created_at = fields.DatetimeField(auto_now_add=True)
    modified_at = fields.DatetimeField(auto_now=True)
